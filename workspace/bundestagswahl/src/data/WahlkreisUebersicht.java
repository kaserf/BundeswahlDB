 ...
 public class WahlkreisUebersicht
 {
   ...
   public WahlkreisUebersicht(Wahlkreis wahlkreis, Kandidat direktkandidat, double wahlbeteiligung, List<Einzelergebnis<Partei, Integer>> stimmenAbsolut, List<Einzelergebnis<Partei, Double>> stimmenProzentual, List<Einzelergebnis<Partei, Double>> stimmenEntwicklung)
   {
   ...
   public void setStimmenProzentual(List<Einzelergebnis<Partei, Double>> stimmenProzentual)
   {
   ...
   public void setStimmenEntwicklung(List<Einzelergebnis<Partei, Double>> stimmenEntwicklung)
   {
   ...
   public void setStimmenAbsolut(List<Einzelergebnis<Partei, Integer>> stimmenAbsolut)
   {
